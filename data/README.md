...
- `papers.json` is the cleaned, committed paper index generated from geospatial paper rows. The live index keeps papers with at least one implementation/resource signal: `links.code`, `links.project_page`, a GitHub URL, or a Hugging Face URL.
